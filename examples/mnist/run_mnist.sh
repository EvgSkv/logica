...
# Trains and evaluates the MNIST digit recognizer written in Logica.
#
# Downloads the dataset into /tmp/logica_mnist if it is not there,
# packs it into a DuckDB database, trains the perceptron on all 60000
# images and prints the accuracy statistics over the 10000 test images.
...
echo "Training on 60000 images and evaluating on 10000 ..."
cd "$REPOSITORY"
export LOGICA_NEURAL_TRACE=1
time python3 logica.py examples/mnist/mnist.l run_in_terminal Summary,PerDigit
